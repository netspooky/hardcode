...
d=e=>{requestAnimationFrame(d);
	...
	for(i=6;i<722;i++)if(_[i]){
		...
		t(A+1,B+2,_[i]|0)}
	//for(i=0;i<38*19;i++) b(8*(i%38),8*~~(i/38),.01)
};d(S=6);
c.onmousedown=e=>S=~~(e.offsetX/24)+38*~~(e.offsetY/24);c.onmouseup=e=>S=6;
...
K="q2w3er5t6y7ui9o0p[=]B\\";T=0;$=Array(22).fill([0,-9]);F=Array(132);

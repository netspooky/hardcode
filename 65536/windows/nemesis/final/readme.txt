nemesis
version 1.02 - now without crash! (hopefully)
A bit smaller on windows, a bit faster on mac.
excess vs. kvasigen
...
Do not believe we'll ever make a not-not-quite-final version.
...
greets go out to
  ...
  yaphan AND BOOZOHOLICS (they rule!)

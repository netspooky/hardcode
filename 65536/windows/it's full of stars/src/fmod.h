...
[
    ...
    Mix behaviour for multichannel sounds can be set with Channel::setSpeakerLevels.<br>
    Channel::setSpeakerMix works but only left and right parameters are used, the rest are ignored.<br>
    <br>
...
[
    ...
    [REMARKS]
    If you are using FMOD_SPEAKERMODE_NONE and speaker assignments are meaningless, just cast a raw integer value to this type.<br>
...
[
    ...
    Win32/Win64 - This is only supported with FMOD_OUTPUTTYPE_DSOUND and EAX compatible sound cards. <br>
    Macintosh - Currently unsupported. <br>
    Linux - Currently unsupported. <br>

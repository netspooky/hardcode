...
FMUSIC_MODULE * FMUSIC_LoadSong(const unsigned char *data, SAMPLELOADCALLBACK sampleloadcallback);
...
/*  MY STUFF */
extern FMUSIC_MODULE *fmod_init(void);
extern int FSOUND_FileDSP;
extern volatile unsigned long int written;

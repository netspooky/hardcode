...
static D3DPRESENT_PARAMETERS devParams = {
  XRES, YRES, D3DFMT_A8R8G8B8, 0, MULTISAMPLE,
    ...
    D3DFMT_D24S8, 0, 0, D3DPRESENT_INTERVAL_DEFAULT };
...
#define A (20+xf)
  ...
  midiOutShortMsg(a,0x000061c0);
  midiOutShortMsg(a,0x7f1990);
  midiOutShortMsg(a,0x7f2090);
  int startTime = timeGetTime();
  do
  {
    float sinofs = (float)(timeGetTime() - startTime)*0.00005;
    campos.x = cos(sinofs)* 95.f;

...
;	mfelix@polbox.com / www.naag.prv.pl
;
;	Updated: 13/11/01
;------------------------------------------------------------
...
REQ_MEM equ 64000 + 65536 + 65536 + 65536 + 64000*2
...
scroll_text	db 'New Age ASM Group proudly presents a short intro made '
		...
		db 'Download programs, sources and tutorials we have! *** '
		db 'Greetings are scrolling to all members of NAAG: HaRv3sTeR, '
		db 'Klemik, tOudi, SEM, Stryket, pkmiecik, Zedd and anybody '
		db 'I forgot... '
		db 30 dup(32),0

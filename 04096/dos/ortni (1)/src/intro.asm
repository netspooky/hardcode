...
;
;  þ Sorry, I had to do many last minute changes on the party place, so
;    the source may not be one of the clearest ever... Anyhow, I didn't
;    even make it to the final, because I didn't have fractal zooming,
;    lightsourced fractals or any huge 3d-world with 9999 objects.
...
stext   db      ' Hi there! This is Yzi''s/Fit contribution to the Asm''94'
        db      ' 4kB intro compo! But nobody likes scrollers, so --->   ', 0

;These text lines are 40 chars each:

ots0    db      'Hi there, It''s me here typing this text.\'
        ...
        db      'OOPS, how did this happen, anyway?MOI?$'
ots1    db      'Yzi/Fit$'
ots2    db      'presents:$'
ots3    db      'ORTNI$'

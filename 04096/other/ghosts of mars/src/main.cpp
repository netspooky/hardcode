...
"Usage: ghosts_of_mars [options]\n"
"For Assembly 2015 4k intro compo.\n"
...
{
  FILE *fd = fopen("ghosts_of_mars.raw", "wb");
...
void write_frame_callback(unsigned screen_w, unsigned screen_h, unsigned idx)
{
  ...
  sstr << "ghosts_of_mars_" << string_format_zero_padded_number(idx, 4) << ".png";

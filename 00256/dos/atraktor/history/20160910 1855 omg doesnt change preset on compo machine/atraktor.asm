...
M:push di       ;=0 (usually) ; sp counts frames
  call I

; combine orange and blue screens and clear them, store to vram
...
; di=0(index into points)
  mov  [bp+si],sp
  fild   word[bp+si]
  fidiv  word[byte si+9h] ; {t/ROTSPEED . . .}
  fsincos              ; {s c . . .}
  fdiv   st1,st0       ; {s c/s . . .}
D:
;rotate
...
I:imul bx,sp,512+64 ; where to start: sp decreases by 2

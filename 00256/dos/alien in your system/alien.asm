;alien.in.your.system
;sensenstahl :: 2o11
;www.sensenstahl.com
;fasm 1.69.31
;listening: vnv nation - resolution
...
mov ax, word [grad]
shr ax,1 ;shl ax,1 for smaller segments
...
;sub ax, bx ;normal
;###
;sub ax, bx ;alienize #1
;or ax, bx  ;
;###
;add ax, bx ;alienize #2
;or ax, bx  ;
;###
;###
...
xor di,bx ;add some noise because it's ugly anyway
stosb
